...
* [**정 원혁**](mailto:williamc@dplus.company) : "전공따위" - 전공에 얽매이지 않고 삽니다. 사회학사, 이러닝석사. 이랜드 개발자로 시작, 마이크로소프트 엔지니어, 프리랜서 8년 후 실직자 구제를 목적으로 (주)필라넷 공동창업. (주)씨퀄로로 분사후 11년차. 데이터베이스 컨설팅과 강의 30년. 이제 또 새로 스타트업, "데이터 분석을 돕는 자" 디플러스 대표 3년차.
