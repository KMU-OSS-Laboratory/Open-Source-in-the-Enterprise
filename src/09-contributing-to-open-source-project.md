...
여러분이 지원하는 소프트웨어에 포함된 도구나 플랫폼 애드온, 플러그인과 같은 중요하지 않는 오픝 소스 코드 프로젝트를 만들어보면서 시작해 볼 수 있습니다.
...
그렇기 때문에 오픈 소스를 이용하는 것이 조직의 비즈니스 목표에 어떻게 도움이 되는지 명확하게 설명할 수 있어야 합니다. 
...
기존의 오픈 소스 프로젝트를 이용하는 가장 좋은 출발점은 해당 프로젝트에 활발하게 기여하고 있는 컨트리뷰터를 고용하는 것입니다. 
...
개발자들이 그 들의 시간을 오픈 소스 프로젝트에 투자할 수 있도록 고용 계약을 다시 확인 하고 수정해야 할 수도 있습니다. 
...
여러분 회사의 직원이 회사의 새로운 코드 작업과 오프소스 참여 두가지 모두를 하려면 어느 정도 훈련이 필요할 것입니다. 
...
이 개발자들은 다른 이들을 멘토링 해야할 의무도 있습니다. 그럼으로써 회사 내부에서든 더 넓은 커뮤니티에서든 개발자들은 오픈 소스 프로젝트에 참여시킬 수 있기 때문입니다. 
앞서 언급했듯, 오픈 소스프로젝트에 참여하는 것은 회사의 개발 능력을 향상시키는 훌륭한 방법입니다.
