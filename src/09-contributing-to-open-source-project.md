...
기존의 오픈 소스 프로젝트를 이용하는 가장 좋은 출발점은 해당 프로젝트에 활발하게 기여하고 있는 컨트리뷰터를 고용하는 것입니다. 몇 몇 기업들은 프로젝트의 리더나 중요 커미터들을 해당 프로젝트에 풀 타임으로 작업하도록 고용하기도 합니다. 또 어떤 기업들은 직원들에게 일정 시간을 오픈소스에 기여하고 그 외의 시간은 해당 오픈소스를 기업에 녹여내는 데에 쓰거나 기업 내부 프로젝트를 진행하는 식으로 균형을 맞추기도 합니다. 
