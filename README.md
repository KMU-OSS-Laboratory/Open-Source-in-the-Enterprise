...
* [Adopting and Using Open Source Code](src/07-adopting-and-using-open-source-code.md) (번역중:장학성)
  ...
  - Assess Potential Projects (번역중:이민석)
  - Comply with the License (번역중:이민석)
  - Manage Community Code as Seriously as the Code You Create (번역중:이민석)
  - Change Your Reward and Management Structure (번역중:이민석)
...
* [Contributing to Open Source Projects](src/09-contributing-to-open-source-project.md) (번역중:김영하)
  ...
  - Set Rules for Participation (번역중:김정묵)
...
* [Launching an Open Source Project](src/10-launching-an-open-source-project.md) (번역중:김영하)
  ...
  - Open the Code Right Out of the Gate (번역중:이민석)
  - Use Best Practices for Stable Code (번역중:이민석)
